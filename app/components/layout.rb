  ...
  class Layout < Base
    ...
    def view_template
      ...
      html lang: "en-US" do
        ...
        body class: "text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-[#141c2b] min-h-full p-4 md:p-8 min-h-screen flex flex-col md:w-2xl md:mx-auto" do
        ...
        footer class: "mt-2 pt-4 sm:pt-0 w-full flex flex-col-reverse sm:flex-row sm:justify-between" do
